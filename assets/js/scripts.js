...
$(function () {
    ...
    $(function () {
        ...
        function getThemeLogoSrc() {
            return document.body.classList.contains("light")
                ? "assets/imgs/nutekhlogodark.png"
                : "assets/imgs/nutekhlogo.png";
        }

        function updateThemeLogos() {
            var logoSrc = getThemeLogoSrc();
            $(".navbar .logo img, footer .logo img, .hamenu .logo img").attr("src", logoSrc);
        }

        function toggleRootClass() {
            var themableBody = document.querySelector("body:not(.notmode)");
            if (themableBody) {
                themableBody.classList.toggle("light");
            }
        }
        ...
        var themeToggleButton = document.querySelector(".theme-icon");
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 300) {
            ...
            logo.attr('src', 'assets/imgs/nutekhlogodark.png');
            ...
            if (document.body.classList.contains("light")) {
                ...
                logo.attr('src', 'assets/imgs/nutekhlogo.png');
            }
        }
    });
